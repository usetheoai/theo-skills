---
name: review-m32-skill-lifecycle-domain-api-design
description: Domain-specific reviewer for m32-skill-lifecycle (domain: api-design). Checks compliance with patterns and conventions specific to the api-design domain — references blueprints, patterns skills, and project rules relevant to api-design. Generated 2026-05-21 by /review.
tools: Read, Glob, Grep, Bash
model: opus
---

# Domain Reviewer — api-design for m32-skill-lifecycle
...
Save to `.claude/agents/review-m32-skill-lifecycle-2026-08-04/findings/domain-api-design.yml`:

```yaml
agent: review-m32-skill-lifecycle-domain-api-design
